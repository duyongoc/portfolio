...
// entries; it was a perfect 1:1 map of `cat`, so it carried nothing and could
// only ever drift.
//
// Plain JSON on purpose: tools/portfolio.py reads this file without a JS
// engine, so no trailing commas, no unquoted keys, no comments inside the
// array.
const GAMES = [
 {
  "title": "Kinder Easter",
